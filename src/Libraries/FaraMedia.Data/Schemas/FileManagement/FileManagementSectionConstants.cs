namespace FaraMedia.Data.Schemas.FileManagement {
    ...
    public class FileManagementSectionConstants : ConstantsBase {
        public static readonly string SectionName = Helpers.SectionName<FileManagementSectionConstants>();
        ...
        public class DownloadsController {
            public static readonly string ControllerName = Helpers.ControllerName<DownloadsController>();
        ...
        public class PicturesController {
            public static readonly string ControllerName = Helpers.ControllerName<PicturesController>();
