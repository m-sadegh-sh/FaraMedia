...
{
    public class PrivateMessagesController : BaseFaraController
    {
        ...
        public ActionResult SendPM(PrivateMessageModel model)
        {
            ...
            try
            {
                ...
                {
                    throw new FaraException(_localizationService.GetResource("PrivateMessages.SubjectCannotBeEmpty"));
                }
                ...
                {
                    throw new FaraException(_localizationService.GetResource("PrivateMessages.MessageCannotBeEmpty"));
                }
