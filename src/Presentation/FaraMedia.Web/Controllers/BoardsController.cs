...
{
    public class BoardsController : BaseFaraController
    {
        ...
        public ActionResult TopicCreate(EditForumTopicModel model)
        {
            ...
            try
            {
                ...
                {
                    throw new FaraException(_localizationService.GetResource("Forum.TopicSubjectCannotBeEmpty"));
                }
                ...
                {
                    throw new FaraException(_localizationService.GetResource("Forum.TextCannotBeEmpty"));
                }
            ...
            string within, string limitDays, int page = 1)
        {
            ...
            try
            {
                if (string.IsNullOrWhiteSpace(searchterms) == false)
                {
                    ...
                    {
                        throw new FaraException(string.Format(_localizationService.GetResource("Forum.SearchTermMinimumLengthIsNCharacters"),
